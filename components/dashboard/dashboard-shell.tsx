...
export function DashboardShell({ user, children }: DashboardShellProps & { children: React.ReactNode }) {
              ...
              <li key={item.href}>
                {isLogout ? (
                  <button
                    ...
                    className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground transition-all duration-200 hover:bg-secondary hover:text-foreground"
                  >
