...
export default function LoginPage() {
  ...
  // Falls back to '/' (never '/dashboard') when no callback is present,
  // and rejects anything that isn't a safe internal path.
        ...
        <StaggerContainer>
          ...
          {error && (
            <motion.div
              ...
              className="mb-4 flex flex-col gap-2 rounded-lg border border-destructive/30 bg-destructive/5 p-3 text-sm text-destructive"
            >
